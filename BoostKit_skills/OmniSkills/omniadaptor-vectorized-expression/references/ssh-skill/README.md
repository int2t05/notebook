...
> 为 Codex / zcode Code 打造的企业级 SSH 管理工具，让远程服务器操作像本地一样简单高效
...
2. zcode Code 用户：将 `ssh-skill` 目录放到 `.zcode/skills/ssh-skill/`。
3. 配置 SSH 密钥或密码认证。
4. 开始使用。
...
## 🎨 与 Codex / zcode Code 集成

在 Codex 或 zcode Code 中，AI 会根据 `SKILL.md` 的描述自动使用 ssh-skill 处理 SSH 操作：
